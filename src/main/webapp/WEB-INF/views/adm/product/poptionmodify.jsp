	...
	<div class="auth-content" style="width: 900px;">
		<div class="card">
			<div class="row align-items-center">
				<div class="col-md-12">
					<div class="card-body">
					<form class="form-horizontal" name="frm" method="post" action="/adm/admin_poption_modify.do">
					<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }">
					
						<input type="hidden" name="pseq" id="pseq">
						<h2 class="mb-4 f-w-400">옵션수정</h2>
					  <div class="form-group">
					    ...
					    <div class=""style="float: left;">
					    	<select name="guide" id="" style="width:100px;height:40px; text-align:center;">
					    		<option value="1"<c:if test="${list.guide == '1'}">selected</c:if>>있음</option>
					    		<option value="2"<c:if test="${list.guide == '2'}">selected</c:if>>없음</option>
					    	</select>
					    </div>
					    ...
					    <div class=""style="display: inline-block;float: left;">
					    	<select name="airline" id="" style="width:100px;height:40px; text-align:center;">
					    		<option value="대한항공"<c:if test="${list.airline == '대한항공'}">selected</c:if>>대한한공</option>
					    		<option value="아시아나"<c:if test="${list.airline == '아시아나'}">selected</c:if>>아시아나</option>
					    	</select>
					    </div>
					    </div>
					    <div class="form-group">
					    ...
					    <div class="ml-4"style="float: left;">
					    	<select name="rentent" id="" style="width:100px;height:40px; text-align:center;">
					    		<option value="롯데렌터카"<c:if test="${list.rentent == '롯데렌터카'}">selected</c:if>>롯데렌터카</option>
					    		<option value="SK렌터카"<c:if test="${list.rentent == 'SK렌터카'}">selected</c:if>>SK렌터카</option>
					    	</select>
					    </div>
					    ...
					    <div class=""style="float: left;">
					    	<select name="rentcar" id="" style="width:100px;height:40px; text-align:center;">
					    		<option value="경차"<c:if test="${list.rentcar == '경차'}">selected</c:if>>경차</option>
					    		<option value="소형"<c:if test="${list.rentcar == '소형'}">selected</c:if>>소형</option>
					    		<option value="중형"<c:if test="${list.rentcar == '중형'}">selected</c:if>>중형</option>
					    		<option value="대형"<c:if test="${list.rentcar == '대형'}">selected</c:if>>대형</option>
					    		<option value="승합"<c:if test="${list.rentcar == '승합'}">selected</c:if>>승합</option>
					    		<option value="SUV"<c:if test="${list.rentcar == 'SUV'}">selected</c:if>>SUV</option>
					    	</select>
					    </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text" name="pcode" class="form-control2" style="width:100%" id="pcode" 
					      value="${list.pcode }" readonly>
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="name" class="ml-4 mr-4"style="float: left;min-width: 70px;">상품명</label>
					    <div class="col-sm-10">
					      <input type="text" name="name" class="form-control2" style="width:100%" id="name" 
					      value="${list.name }">
					    </div>
					  </div>
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text" name="hotel" class="form-control2" style="width:100%" id="hotel" 
					      value="${list.hotel }">
					    </div>
					  </div>
					 <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text" name="count" class="form-control2" style="width:100%" id="count" 
					      value="${list.count }">
					    </div>
					  </div>
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text" name="hash" class="form-control2" style="width:100%" id="hash" 
					      value="${list.hash }">
					    </div>
					  </div>
					  <div class="form-group">
					    ...
					    <fmt:parseDate var="startdate" value="${list.startdate }" pattern="yyyy-MM-dd"/>
					      <input type="text" name="startdate" class="form-control2" style="width:100%" 
					  ...
					  <div class="form-group">
					    ...
					    <fmt:parseDate var="enddate" value="${list.enddate }" pattern="yyyy-MM-dd"/>
					      <input type="text" name="enddate" class="form-control2" style="width:100%" 
					      id="enddate" value="<fmt:formatDate value="${enddate }" pattern="yyyy-MM-dd"/>">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="price1" class="ml-4 mr-4"style="float: left;min-width: 70px;">원가</label>
					    <div class="col-sm-10">
					      <input type="text" name="price1" class="form-control2" style="width:100%" id="price1" 
					      onkeypress="numberformat(this)" value="${list.price1 }">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="price2" class="ml-4 mr-4"style="float: left;min-width: 70px;">판매가</label>
					    <div class="col-sm-10">
					     <input type="text" name="price2" class="form-control2" style="width:100%" id="price2" 
					     onBlur="go_ab()" onkeypress="numberformat(this)" value="${list.price2 }">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="price3" class="ml-4 mr-4"style="float: left;min-width: 70px;">순이익</label>
					    <div class="col-sm-10">
					      <input type="text" name="price3" class="form-control2" style="width:100%" id="price3" 
					      readonly onblur="numberformat(this)"  value="${list.price3 }">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="content" class="ml-4 mr-4"style="float: left;min-width: 70px;">상품설명</label>
					    <div class="col-sm-10">
					      <textarea name="content" class="form-control2" style="width:100%" 
					      id="summernote">${list.content }</textarea>
					    </div>
					  </div>
					  <!-- <div class="form-group">
