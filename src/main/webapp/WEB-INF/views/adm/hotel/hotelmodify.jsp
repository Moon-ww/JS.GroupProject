				...
				<h2>호텔등록</h2>
					...
					<input type="hidden" name="hseq" value="${list.hseq}">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text" name="roomcount" class="form-control" style="width:100%" id="roomcount" value="${list.roomcount }">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="location" class="col-sm-2 control-label">위치</label>
					    <div class="col-sm-10">
					    	<input type="text" name="location" class="form-control" style="width:100%" id="location" value="${list.location }">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="hashtag" class="col-sm-2 control-label">해시태그</label>
					    <div class="col-sm-10">
					      <input type="text" name="hash" class="form-control" style="width:100%" id="hash" value="${list.hash }">
					    </div>
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text" name="image" class="form-control" id="image" value="${list.image }">
					      <input type="file" name="uploadFile2" class="form-control" id="img2">
					    </div>
					  </div>
					  <div class="form-group">
