				...
				<div class="col-md-12">
					...
					<h2 class="mb-4 f-w-400">호텔등록</h2>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text" name="roomcount" class="form-control2" style="width:100%" id="roomcount">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="location" class="col-sm-2 control-label">위치</label>
					    <div class="col-sm-10">
					    	<input type="text" name="location" class="form-control2" style="width:100%" id="location">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="hashtag" class="col-sm-2 control-label">해시태그</label>
					    <div class="col-sm-10">
					      <input type="text" name="hashtag" class="form-control2" style="width:100%" id="hashtag" placeholder="태그입력">
					    </div>
					  </div>
					  <div class="form-group">
