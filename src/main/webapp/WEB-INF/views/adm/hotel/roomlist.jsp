				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">객실관리</h2>
					    ...
					    <c:choose>
					    	...
					    	<c:otherwise>
							    ...
							    <tr>
							    	...
							    	<td>${list.options }</td>
							    	<td nowrap><fmt:formatNumber value="${list.price }"/> 원</td>
							    	<td><a href="/adm/hotel/roommodify.do?title=${list.title }" class="pbtn btn btn-info">수정</a> <a href="" class="pbtn btn btn-danger">삭제</a></td>
							    </tr>
							    </c:forEach>
						    </c:otherwise>
					    </c:choose>
