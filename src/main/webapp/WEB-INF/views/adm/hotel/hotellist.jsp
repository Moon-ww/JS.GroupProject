				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">호텔관리</h2>
					    ...
					    <c:choose>
					    	...
					    	<c:otherwise>
							    ...
							    <tr>
							    	...
							    	<td><a href="/adm/hotel/roomlist.do?hseq=${list.hseq }" class="pbtn btn btn-secondary">객실</a> <a href="/adm/hotel/hotelmodify.do?hseq=${list.hseq }" class="pbtn btn btn-info">수정</a> <a href="/adm/hotel/hoteldelete.do?hseq=${list.hseq }" class="pbtn btn btn-danger">삭제</a></td>
							    </tr>
							    </c:forEach>
						    </c:otherwise>
					    </c:choose>
					  </table>
					  <a href="/adm/hotel/hotelwrite.do" class="btn btn-default" style="float:right;">호텔등록</a>
											</div>
										</div>
									</div>
								</div>
