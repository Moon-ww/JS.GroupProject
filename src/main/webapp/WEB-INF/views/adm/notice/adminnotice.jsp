				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">공지사항관리</h2>
			...
			<div class="col-md-12">
				<div class="table-responsive">
					<table class="table">
					    ...
					    <c:choose>
					    	...
					    	<c:otherwise>
							    ...
							    <tr>
							    	<td>${list.nseq }</td>
							    	<td>${list.kind }</td>
							    	<td><a href="admin_notice_view.do?nseq=${list.nseq }">${list.title }</a></td>
							    	<td><fmt:parseDate var="regdate" value="${list.regdate }" pattern="yyyy-MM-dd"/>
									<fmt:formatDate value="${regdate }" pattern="yyyy-MM-dd"/></td>
							    	<td><a href="/adm/notice/noticemodify.do?nseq=${list.nseq }" class="pbtn btn btn-info">수정</a> <a href="/adm/admin_notice_delete.do?nseq=${list.nseq }" class="pbtn btn btn-danger">삭제</a></td>
					  ...
					  <a href="/adm/notice/noticewrite.do" class="btn btn-default" style="float:right;">공지등록</a>
											</div>
										</div>
									</div>
								</div>
