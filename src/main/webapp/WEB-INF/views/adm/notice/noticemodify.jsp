				...
				<div class="col-md-12">
					...
					<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }">
					  ...
					  <div class="form-group">
					    ...
					    <div class=""style="float: left;margin-left: 20px;">
					    	<select name="kind" id="" style="width:80px;height:40px; text-align:center;">
					    		<option value="일반"<c:if test="${list.kind == '일반'}">selected</c:if>>일반</option>
					    		<option value="서비스"<c:if test="${list.kind == '서비스'}">selected</c:if>>서비스</option>
					    		<option value="당첨자발표"<c:if test="${list.kind == '당첨자발표'}">selected</c:if>>당첨자발표</option>
					    	</select>
					    </div>
					  </div> 
					  <div class="form-group">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <textarea name="content" class="form-control2" style="width:100%" id="summernote">
