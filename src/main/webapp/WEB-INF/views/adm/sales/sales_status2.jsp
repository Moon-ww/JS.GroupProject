<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.min.css">
 	...
 	<div class="container" style="margin-top:150px;">
		...
		<canvas id="myChart2"></canvas><br><a href="/adm/sales/sales_status.do" class="btn btn-primary">매출액 보기</a>
		<a href="/adm/sales/sales_status3.do" class="btn btn-primary">판매량 보기</a>
		</div>
		</div>
	</div>
<script> 
 	var ctx = document.getElementById('myChart2');
 	var aprice3 = $("#aprice3").val();
 	var bprice3 = $("#bprice3").val();
 	var cprice3 = $("#cprice3").val();
 	var dprice3 = $("#dprice3").val();
 	var eprice3 = $("#eprice3").val();
 	var fprice3 = $("#fprice3").val();
 	var gprice3 = $("#gprice3").val();
 	var hprice3 = $("#hprice3").val();
 	var iprice3 = $("#iprice3").val();
 	var jprice3 = $("#jprice3").val();
 	var kprice3 = $("#kprice3").val();
 	var lprice3 = $("#lprice3").val();
 	var myChart = new Chart(ctx, { 
 		type: 'line', 
 		data: { 
 			labels: ['1월', '2월', '3월', '4월', '5월', '6월', '7월', '8월', '9월', '10월', '11월', '12월'], 
 			datasets: [{ label: '순이익', data: [5000, 12000, 9000, 20000, 25000, 30000, 25000, 30000, 10000, 30000, 35000, 40000], 
 			fill : false ,
 	 		lineTension : 0.5,
 			backgroundColor: [ 
 				'rgba(255, 99, 132, 0.2)',
