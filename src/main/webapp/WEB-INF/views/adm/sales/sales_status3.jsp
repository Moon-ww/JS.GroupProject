<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.min.css">
 	...
 	<div class="container" style="margin-top:150px;">
 		<div class="row">
 			<div class="col-md-2">
 				<table>
 					...
 					<tr id="12월">
 						<td><input type="hidden" id="lqnt" value="${list12.totalqnt }"></td>
		...
		<canvas id="pieChartCanvas" width="470px" height="470px"></canvas><br><a href="/adm/sales/sales_status.do" class="btn btn-primary">매출액 보기</a>
		<a href="/adm/sales/sales_status2.do" class="btn btn-primary">순이익 보기</a>
		</div>
		</div>
	</div>
 	<script> 
