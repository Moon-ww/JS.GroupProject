<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.min.css">
 	...
 	<div class="container" style="margin-top:150px;">
		...
		<canvas id="myChart"></canvas><br><a href="/adm/sales/sales_status2.do" class="btn btn-primary">순이익 보기</a>
 	...
 	var myChart = new Chart(ctx, { 
 		...
 		data: { 
 			...
 			datasets: [{ label: '매출액', data: [10000, 20000, 30000, 25000, 50000, 40000, 45000, 70000, 20000, 50000, 40000, 70000], 
 			fill : false ,
 			lineTension : 0.5,
 			backgroundColor: [ 
 				'rgba(255, 99, 132, 0.2)',
