		...
		<div class="swiper-container swiper2" style="width:150px; height: 26px; position: absolute; top:16px; left: 450px;">
		  ...
		  <div class="swiper-button-next"></div> -->
                     ...
                     <li class="dropdown">
                         ...
                         <li style="margin:10px;" class="nothover"><a href="/member/login"><span class="log">로그인</span></a></li>
                  		 <li style="margin:10px;" class="nothover"><a href="/member/join.do"><span class="log2">회원가입</span></a></li>
                         </sec:authorize>
                         <sec:authorize access="isAuthenticated()">
                         	<li style="padding:10px; background: #c9c9c9;"><span style="color: #007aff"><%=name %></span> 님, 반갑습니다</li>
							<li style="margin:10px;" class="nothover"><a href="/mypage/reservList.do">예약내역</a></li>
							<li style="margin:10px;" class="nothover"><a href="/mypage/dibs.do">찜</a></li>
							<li style="margin:10px;" class="nothover"><a href="/mypage/mileage.do">마일리지</a></li>
							<li style="margin:10px;" class="nothover"><a href="/mypage/mypage.do">마이페이지</a></li>
							<li style="margin:10px;" class="nothover"><a href="/mypage/qnaList.do">1:1 게시판문의</a></li>
							<li style="margin:10px;" class="nothover"><a href="/mypage/mypage.do">개인정보수정</a></li>
							</sec:authorize>
                         </ul>
                       </li>
                       <sec:authorize access="isAnonymous()">
                       <li><a href="/member/login"><img src="/resources/images/reservation.png" alt="예약내역"/></a></li>
                       <li><a href="/member/login"><img src="/resources/images/zzim.png" alt="찜"/></a></li>
                       </sec:authorize>
                       <sec:authorize access="isAuthenticated()">
                       <li><a href="/mypage/reservList.do"><img src="/resources/images/reservation.png" alt="예약내역"/></a></li>
                       <li><a href="/mypage/dibs.do"><img src="/resources/images/zzim.png" alt="찜"/></a></li>
                       </sec:authorize>
                ...
                <div class="mainmenu pull-left myleft">
                   <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                     <ul class="nav navbar-nav">
                       <li><a href="/product/productlist.do">제주/국내여행 </a></li>
                       <li><a href="/hotel/hotellist.do">호텔/펜션</a></li>
                     </ul>
                   </div>
                </div>
               </div>
